...
export const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <article
      ...
      className="group bg-white rounded-2xl border border-slate-200/90 overflow-hidden flex flex-col hover:border-orange-300 hover:shadow-lg transition-all duration-200 cursor-pointer text-left"
    >
      ...
      <div className="p-4 flex-1 flex flex-col justify-between">
        <div>
          ...
          <div className="flex items-center justify-between text-xs text-slate-500 mb-1.5">
            <span className="font-semibold text-orange-600">{product.category}</span>
            {product.rating && (
          ...
          {/* Product Title */}
          <h3 className="font-bold text-slate-900 text-sm sm:text-base leading-snug line-clamp-2 mb-2 group-hover:text-orange-600 transition-colors">
            {product.title}
          </h3>
        ...
        <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
          ...
          <button
            type="button"
            className="flex-1 py-2 px-3 rounded-xl bg-orange-50 hover:bg-orange-100 text-orange-700 font-semibold text-xs flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
          >
          ...
          <button
            ...
            className="py-2 px-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-medium text-xs flex items-center gap-1 transition-colors cursor-pointer shrink-0"
